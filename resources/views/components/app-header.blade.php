            ...
            <li class="nav-item dropdown has-arrow main-drop profile-nav">
            	...
            	<div class="dropdown-menu menu-drop-user">
            		<div class="profileset d-flex align-items-center">
            			...
            			<div>
            				<h6 class="fw-medium">Super Admin</h6>
            				<p>Admin</p>
            			</div>
            		</div>
            		...
            		<a onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="dropdown-item logout pb-0" href="#"><i class="ti ti-logout me-2"></i>Logout</a>
            	</div>
            </li>
        </ul>
        <!-- /Header Menu -->
