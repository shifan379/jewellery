				...
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						<li class="submenu-open">
							...
							<ul>
                                <li><a href="{{ route('dashboard') }}"><i class="ti ti-layout-grid fs-16 me-2"></i><span>Dashboard</span></a></li>
							</ul>
						</li>
						<li class="submenu-open">
						...
						<li class="submenu-open">
							...
							<ul>
								<li><a href="{{route('manage_stock')}}"><i class="ti ti-stack-3 fs-16 me-2"></i><span>Manage Stock</span></a></li>
								<li><a href="{{ route('stock.adjustment') }}"><i class="ti ti-stairs-up fs-16 me-2"></i><span>Stock Adjustment</span></a></li>
								<li><a href="{{ route('stock.transfer') }}"><i class="ti ti-stack-pop fs-16 me-2"></i><span>Stock Transfer</span></a></li>
							</ul>
						</li>
						<li class="submenu-open">
							<h6 class="submenu-hdr">Sales</h6>
							<ul>
                                <li><a href="{{ route('today.rate') }}"><i class="ti ti-file-invoice fs-16 me-2"></i><span>Today Rate</span></a></li>
                                <li><a href="{{ route('sales') }}"><i class="ti ti-file-invoice fs-16 me-2"></i><span>Sales</span></a></li>

								<li><a href="{{ route('invoice.index') }}"><i class="ti ti-file-invoice fs-16 me-2"></i><span>Invoices</span></a></li>
								<li><a href="{{ route('quotation.index') }}"><i class="ti ti-files fs-16 me-2"></i><span>Quotation</span></a></li>
                                <li><a href="{{ route('customer-due.index') }}"><i class="ti ti-user-star fs-16 me-2"></i><span>Customer Due</span></a></li>
							</ul>
						</li>
						<li class="submenu-open">
						...
						<li class="submenu-open">
							...
							<ul>
								<li><a href="{{route('employee.list')}}"><i class="ti ti-user fs-16 me-2"></i><span>Employees</span></a></li>
						...
						<li class="submenu-open">
							...
							<ul>
                                <li><a href="{{ route('salesReport.index') }}"><i class="ti ti-chart-bar fs-16 me-2"></i><span>Sales Report</span></a></li>
								<li><a href="{{ route('purchaseReport.index') }}"><i class="ti ti-chart-pie-2 fs-16 me-2"></i><span>Purchase report</span></a></li>
								<li class="submenu">
