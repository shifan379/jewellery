...
<x-app-layout>
    ...
    @section('content')
            ...
            <div class="page-header">
                <div class="add-item d-flex">
                    <div class="page-title">
                        <h4 class="fw-bold">Today Rate</h4>
                        <h6>Add your today rate categories</h6>
                    </div>
                </div>
                ...
                <div class="page-btn">
                    <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-category"><i
                            class="ti ti-circle-plus me-1"></i>Add Rate</a>
                </div>
            </div>
        ...
        <div class="modal fade" id="add-category">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="{{ route('today.rate.store') }}" method="POST">
                        @csrf
                        <div class="modal-body">
                            <div class="mb-3">
                                <label class="form-label">Category<span class="text-danger ms-1">*</span></label>
                                <Select required name="categoryID" class="form-select">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" required name="rate" min="1" step="0.00" class="form-control">
                            </div>
        ...
        <div class="modal fade" id="edit-category">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="{{ route('today.rate.update') }}" method="POST" >
                        @csrf
                        <div class="modal-body">
                            <input type="hidden" name="id"  id="edit_sub_id">
                            <div class="mb-3">
                                <label class="form-label">Category<span class="text-danger ms-1">*</span></label>
                                <Select required name="categoryID" id="edit_rate_category" class="form-select">
                                    <option value="" disabled selected>Select Category</option>
                                    @forelse ($categories as $cat)
                                        <option value="{{ $cat->id }}">{{ $cat->category }}</option>
                                    @empty
                            ...
                            <div class="mb-3">
                                <label class="form-label">Rate<span class="text-danger ms-1">*</span></label>
                                <input type="number" class="form-control" required id="edit_rate" name="rate">
                            </div>
        ...
        <div class="modal fade" id="delete-modal">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form action="{{ route('today.rate.destroy') }}" method="POST">
                        @csrf
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                editButtons.forEach(btn => {
                    btn.addEventListener('click', function() {
                        ...
                        document.getElementById('edit_rate').value = name;


                        // Set the category dropdown selected value
                        const select = $('#edit_rate_category');
                        ...
                        if (select.find(`option[value="${category_id}"]`).length) {
                            ...
                            select.append(`<option value="${category_id}" selected>${category}</option>`);
                        }
